...
// Clase que renderiza el listado de opciones o botones
// para acceder a las distintas secciones del a aplicacion.
      ...
      children: [
        ...
        TableRow(children: [
          ...
          GestureDetector( 
            ...
            child: const SingleCard(icon: "assets/images.png", text: "Incidencias"),
          )
        ])
      ],
    );
