...
class IncidenciasScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String usuarioAppbar = FirebaseAuth.instance.currentUser?.displayName.toString() ?? "nulo";
    String correoProvider = FirebaseAuth.instance.currentUser?.email.toString() ?? "nulo";
    ...
    var appBar = AppBar(
      ...
      actions: [
        ...
        Padding(
          ...
          child: IconButton(onPressed: funcionRetroceder, icon: const Icon(Icons.output)),
